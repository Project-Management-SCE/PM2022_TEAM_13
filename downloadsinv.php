...
<tbody>
  ...
  $inv = new Invest($file['investor']);
  $usr = new User($inv->data()->investor);
  $name=$usr->data()->first_name . " " . $usr->data()->last_name;
    ?>
    <tr>
      ...
      <td><?php echo $name; ?></td>
      <td><a href="downloadsinv.php?file_id=<?php echo $file['id'] ?>">Download</a><br><br>
          <a href="deleteinvFiles.php?fname=<?php echo $file['name'] ?>&Fid=<?php echo $file['id'] ?>&Pid=<?php echo $file['investor'] ?>">Delete</a>
      </td>
    </tr>
  <?php endforeach;?>
