...
?>  
 ...
 <div id="id01" class="modal" >
		...
		<form id="Cform1" class="modal-content animate" action="investAproove.php" method="post" enctype="multipart/form-data">	
				...
				<div class="container">
					...
					<label for="Pid">מספר פרוייקט</label><br>
					<input type="text" id="Pid" name="Pid" readonly><br>
					<label for="gainper">אחוז רווח בהשקעה %</label><br>
					<input type="text" id="gainper" name="gainper" ><br>
          <label for="gainper2">אחוז רווח % לפני מ"ס</label><br>
          <input type="text" id="gainper2" name="gainper2" ><br>

					<label  for="myfile">בחר קובץ</label>
	           		<input type="file" name="myfile" class="fcf-form-control"> <br>
       	 		<button type="submit" name="save">אשר השקעה</button>	  
    	  		</div>
    ...
    <form id="Cform2" class="modal-content animate" action="investDecline.php" method="post" > 
        ...
        <div class="container">
          ...
          <label for="Pid2">מספר פרוייקט</label><br>
          <input type="text" id="Pid2" name="Pid2" readonly><br>
            <button type="submit" name="save">סרב השקעה</button>    
            </div>
    ...
    <form id="Cform3" class="modal-content animate" action="PayInv.php" method="post" > 
        ...
        <div class="container">
          <label for="Inivid3">מספר השקעה</label><br>
          <input type="text" id="Invid3" name="Invid3" readonly><br>
          <label for="investor3">משקיע</label><br>
          <input type="text" id="investor3" name="investor3" readonly><br>
          <label for="amount3">סכום לתשלום</label><br>
          <input type="text" id="amount3" name="amount3" readonly><br>
...
<script type="text/javascript" src="js/getinvestsData.js"></script>
