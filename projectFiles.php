...
?>  
  ...
  <div class="fcf-body">
    ...
    <div id="fcf-form">
    <h1 class="fcf-h3">העלאת קבצים לתוכנית עסקית</h1>
        <form action="projectFiles.php" class="fcf-form-class" method="post" enctype="multipart/form-data" >
         <div class="fcf-form-group">
         <label class="fcf-label" for="Aid">בחר פרוייקט</label>
          ...
          <select id="f4" name="Aid" id="Aid" class="fcf-form-control" >
            <option value=" ">בחר פרוייקט</option>
                ...
                <?php 
                  ...
                  $query1 = sprintf("SELECT projects.id, projects.Pname ,association.Aname FROM projects INNER JOIN association ON projects.Aid = association.id WHERE hasfile ='0'");
                  //execute query
                  ...
                  foreach ($result1 as $data) {
                    echo "<option value='". $data['id'] ."'>" .$data['Pname']."-".$data['Aname']."</option>";  // displaying data in option menu
                  }
       ...
       <div class="fcf-form-group">
         <label class="fcf-label" for="myfile">בחר קובץ</label>
        <div class="fcf-input-group">
