node {
  stage("Main") {
    ...
    docker.image('php:8.1.3-alpine').inside("-e COMPOSER_HOME=/tmp/jenkins-workspace") {
      ...
      ssh "root@46.101.154.62"
        sh "cd /var/www/html"
        sh "ls"
        sh "git clone https://gunrcisus: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https://github.com/Project-Management-SCE/PM2022_TEAM_13.git"
      }
